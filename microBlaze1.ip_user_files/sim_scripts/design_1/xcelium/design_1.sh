...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../microBlaze1.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"$ref_dir/../../../../microBlaze1.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../microBlaze1.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"../../../../microBlaze1.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       -input simulate.do
}
